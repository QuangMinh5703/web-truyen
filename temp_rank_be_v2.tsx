...
const TopRankings = () => {
            ...
            <section className="mb-12">
                <div className="relative w-full h-80 rounded-2xl overflow-hidden bg-gray-800 animate-pulse">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-white text-xl">膼ang t岷...</div>
                    </div>
                </div>
            </section>
        );
    ...
    const topStories = movieTop.slice(1, 5); // L岷 4 truy峄噉 ti岷縫 theo

    const movieName = movie.name || movie.title || 'Truy峄噉 tranh';
                ...
                <div className="basis-1/4 flex items-center justify-center top-ranking-stories-list rounded-2xl">
                    <div className="space-y-3 ">
                        {topStories.map((story, index) => {
                            const storyName = story.name || story.title || 'Truy峄噉 tranh';
